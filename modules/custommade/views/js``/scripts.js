...
*/
        (function ($) {
            ...
            var jobId = '1';
            var base_url = 'http://localhost/prestashop-latest';
            ...
            function makeTransformation(type, id, data) {
                ...
                switch (type) {
                    case 'crop':
                        url = "http://localhost/prestashop-latest/transform/0/crop";
                        break;
                    case 'rotate':
                        url = "http://localhost/prestashop-latest/transform/0/rotate";
                        break;
                    case 'flip':
                        url = "http://localhost/prestashop-latest/transform/0/flip";
                        break;
                    case 'filter':
                        url = "http://localhost/prestashop-latest/0/filter";
                        break;
                    default:
                        return false;
                }
